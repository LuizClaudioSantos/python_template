...
fmt:              ## Format code using black & isort.
	...
	$(ENV_PREFIX)black -l 79 python_template/
	$(ENV_PREFIX)black -l 79 tests/

.PHONY: lint
lint:             ## Run pep8, black, mypy linters.
	$(ENV_PREFIX)flake8 python_template/
	$(ENV_PREFIX)black -l 79 --check python_template/
...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@echo "python_template = 'python_template.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run python_template'"
